						...
						<div class="sidebar__item">
							...
							<ul>
								<c:forEach var="branch" items="${listBranchs }">
									<li><a href="/contents/${branch.name}/${branch.id}">${branch.name }</a></li>
								</c:forEach>
							</ul>
						</div>
						<div class="sidebar__item">
						...
						<div class="row">
							<div class="col-lg-4 col-md-5">
								<div class="filter__sort">
									<span>Tìm kiếm theo</span> <select id="select">
								...
								<ul class="pagination pagination">
									<c:if test="${totalItems > 0 }">
										<c:choose>
											...
											<c:otherwise>
												<li><a href="/${cUrl }&${sort}&page=${1 }">First</a></li>
												<li><a href="/${cUrl }&${sort}&page=${current - 1 }">Prev</a></li>
											</c:otherwise>
										</c:choose>
										...
										<c:forEach begin="${begin }" end="${end }" var="i">
											<c:choose>
												<c:when test="${i == current }">
													<li class="active"><a
														href="/${cUrl }&${sort}&page=${i }">${i }</a></li>
												</c:when>
												<c:otherwise>
													<li><a href="/${cUrl }&${sort}&page=${i }">${i}</a></li>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										...
										<c:choose>
											<c:when test="${current == 1 && totalItems > 12}">
												<li><a href="/${cUrl }&${sort}&page=${current + 1}">Next</a></li>
												<li><a href="/${cUrl }&${sort}&page=${last }">Last</a></li>
											</c:when>
